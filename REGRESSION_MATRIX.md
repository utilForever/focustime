...
| WakaTime v0.17 scope | WakaTime stays in product positioning as optional heartbeat tracking, with follow-up cleanup targeting fire-and-forget delivery and removal of queue/replay runtime surfaces rather than full WakaTime removal. | `README.md`, `CHANGELOG.md`, `ARCHITECTURE.md` roadmap notes before implementation issues remove runtime surfaces |
