...
| Retired blocking workflows | Break-glass and temporary allowlist command paths stay removed while supported blocklist/allowlist profile rules remain available. | `parse_break_glass_commands_are_removed_with_guidance`, `usage_text_omits_break_glass_commands`, `temporary_allowlist_add_json_command_is_removed`, `site_manager_renders_allowlist_mode_labels` |
