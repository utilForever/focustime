...
| Retired blocking workflows | Break-glass, temporary allowlist, and blocklist profile command paths stay removed while supported canonical blocklist/allowlist rules remain available. | `parse_break_glass_commands_are_removed_with_guidance`, `usage_text_omits_break_glass_commands`, `parse_blocklist_profile_commands_are_retired`, `temporary_allowlist_add_json_command_is_removed`, `site_manager_renders_allowlist_mode_labels` |
