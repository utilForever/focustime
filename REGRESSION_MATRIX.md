...
| v0.15.7 | Standalone usage-signal CLI access stays removed as a plain unknown option while feature inventory remains the cleanup/reporting workflow. | Usage cleanup | `v015_removed_command_paths_follow_plain_unknown_option_json_baseline` plus `v015_removed_command_text_errors_follow_plain_unknown_option_baseline` |
