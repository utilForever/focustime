...
| Schedule and calendar cleanup | Schedules and session templates remain the supported automation model while calendar annotation caches, standalone calendar refresh, weekday, and automation command paths stay absent. | `load_with_env_ignores_legacy_calendar_sync_without_warning`, `save_with_env_omits_legacy_calendar_sync_section`, `recurring_schedule_text_has_no_calendar_annotations`, `parse_calendar_sync_is_retired`, `parse_weekday_rules_is_retired`, `parse_automation_triggers_is_retired`, `migrate_deprecated_schedule_shims_removes_weekday_rules_and_automation_triggers` |
