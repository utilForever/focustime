...
| v0.15.2 | Raw usage-signal summaries remain internal cleanup inputs while GitHub roadmap issues, release notes, and static docs are the cleanup planning source of truth. | Usage cleanup | `v015_cleanup_docs_keep_matrix_and_release_guidance_aligned` |
...
| v0.16.1 | Feature inventory CLI export and committed generated inventory snapshots stay retired; `--feature-inventory` is absent from help and command parsing while cleanup planning points to GitHub roadmap issues, release notes, and static documentation. | Usage cleanup | `parse_feature_inventory_is_retired`, `feature_inventory_json_command_is_retired`, and `v015_cleanup_docs_keep_matrix_and_release_guidance_aligned` |
