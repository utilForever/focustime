...
const FEATURE_SEEDS: &[FeatureSeed] = &[
    ...
    FeatureSeed {
        ...
        surface: FeatureSurface::Schedule,
        description: "Removed compatibility shims for weekday defaults; use schedules and session templates.",
        cli_flags: &[],
        value: 2,
        complexity: 2,
        support_burden: 4,
    ...
    FeatureSeed {
        ...
        name: "Removed automation trigger rule shims",
        surface: FeatureSurface::Schedule,
        description: "Removed standalone trigger compatibility; use schedules, schedule delay, and session templates.",
        cli_flags: &[],
        value: 2,
        complexity: 2,
        support_burden: 4,
    ...
    FeatureSeed {
        ...
        surface: FeatureSurface::Stats,
        description: "Focus History uses a stable default KPI layout exposed through the history dashboard command.",
        cli_flags: &["--history-dashboard"],
        value: 4,
        complexity: 3,
        support_burden: 3,
        failure_impact: 2,
    ...
    FeatureSeed {
        ...
        description: "Read an opt-in calendar busy-window cache used only as schedule annotations; standalone refresh is removed.",
        cli_flags: &[],
        value: 2,
        complexity: 3,
        support_burden: 4,
